...
Helixer/export.py --db-path-in three_algae/three_algae.sqlite3   --genomes Ostreococcus_lucimarinus,Cyanidioschyzon_merolae --out-dir example/unfiltered_train
...
python3 Helixer/scripts/filter_fully_erroneous.py -d example/unfiltered_test/test_data.h5 \
...
#python3 Helixer/helixer/prediction/LSTMModel.py --load-model-path example/best_helixer_model.h5 --test-data example/test/test_data.h5 --prediction-output-path example/mpusillaCCMP1545_predictions.h5
